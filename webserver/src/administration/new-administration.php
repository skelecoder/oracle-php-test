						...
						<div class="col-lg-12">
							<div id="panel-misc-portlet-r5" class="panel panel-default">
								...
								<div class="panel-heading">
									<a class="btn btn-primary btn-xs" href="./administrations.php"><< Retour</a>
								</div>
		...
		<script type="text/javascript">
			$('form').submit(function(ev) {
				...
				$.ajax({
					...
					data: $('form').serialize()+"&niveau=<?php echo $niveau; ?>",
					success: function(data) {
						if(data.response.status == 'success'){
							window.location.replace('administrations.php?niveau=<?php echo $niveau; ?>');
						}else{
