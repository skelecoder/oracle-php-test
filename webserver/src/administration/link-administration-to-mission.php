...
<html lang="en-US">
	...
	<body>
		...
		<div id="wrapper">
			...
			<section id="middle">
				...
				<header id="page-header">
					<h1>Ajouter un organisme à controler</h1>
				</header>
				<!-- /page title -->
            ...
            <div class="row margin-bottom-20">
							<div class="col-lg-12">
                <a class="btn btn-default btn-xs" href="./edit-mission.php?id=<?php echo $mission_id; ?>"><< Retour à la mission</a>
              </div>
            </div>
						<div class="row">
							<div class="col-lg-12">
								<div id="panel-misc-portlet-r5" class="panel panel-default">
									...
									<div class="panel-heading">
										<span class="elipsis"><!-- panel title -->
											<strong>Mission: <?php echo stripcslashes($mission['TITLE_FR']); ?></strong>
										</span>
									</div>
      ...
      $('form').submit(function(ev) {
				...
				$.ajax({
					type: 'POST',
					url: 'add-missionId-administrationId.php',
					data: $('form').serialize()+"&mission_id="+<?php echo $mission_id; ?>,
					success: function(data) {
